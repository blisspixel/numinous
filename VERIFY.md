...
Expected right now: **format and clippy clean, 1,011 tests pass, 91.61% region
cover, and 91.23% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
