...
Expected right now: **format and clippy clean, 3,723 passing all-target Rust test cases,
...
ignored by the ordinary all-target run, 94.24% region coverage, and 94.25% line
