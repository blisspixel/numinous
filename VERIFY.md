...
Expected right now: **format and clippy clean, 941 tests pass, 91.17% region
cover, and 90.71% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
