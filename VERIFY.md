...
Expected right now: **format and clippy clean, 1,016 tests pass, 91.80% region
cover, and 91.40% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
