...
Expected right now: **format and clippy clean, 927 tests pass, 91.13% region
cover, and 90.66% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
