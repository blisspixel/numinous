...
Expected right now: **format and clippy clean, 3,495 passing all-target Rust test cases,
...
ignored by the ordinary all-target run, 95.11% region coverage, and 95.23% line
