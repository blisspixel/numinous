...
Expected right now: **format and clippy clean, 897 tests pass, 90.55% region
cover, and 90.11% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
