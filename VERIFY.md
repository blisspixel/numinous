...
Expected right now: **format and clippy clean, 928 tests pass, 91.14% region
cover, and 90.67% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
