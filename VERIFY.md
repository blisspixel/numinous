...
Expected right now: **format and clippy clean, 947 tests pass, 91.17% region
cover, and 90.72% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
