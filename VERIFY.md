...
Expected right now: **format and clippy clean, 858 tests pass, 90.18% region
cover, and 89.84% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
