...
Expected right now: **format and clippy clean, 864 tests pass, 90.26% region
cover, and 89.89% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
