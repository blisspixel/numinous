...
Expected right now: **format and clippy clean, 926 tests pass, 90.87% region
cover, and 90.40% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
