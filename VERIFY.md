...
Expected right now: **format and clippy clean, 870 tests pass, 90.33% region
cover, and 89.94% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
