...
Expected right now: **format and clippy clean, 963 tests pass, 91.28% region
cover, and 90.83% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
