...
Expected right now: **format and clippy clean, 918 tests pass, 90.79% region
cover, and 90.32% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
