...
Expected right now: **format and clippy clean, 882 tests pass, 90.50% region
cover, and 90.09% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
