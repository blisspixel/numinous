...
Expected right now: **format and clippy clean, 938 tests pass, 91.16% region
cover, and 90.70% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
