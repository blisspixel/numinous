...
Expected right now: **format and clippy clean, 914 tests pass, 90.71% region
cover, and 90.25% line cover** (the `gpu` and `audio` crates plus the app event-loop file are
