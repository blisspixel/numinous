...
- `scripts/agent-tactile.py` gates Times Tables and Galton Board on listen_room
  note differences after the hand, so 0.3 sonic consequence is machine-checked.
