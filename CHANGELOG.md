...
- Status docs now match current evidence: 30 catalog rooms plus hidden content, 26 MCP tools, 814 passing tests, 89.60% region cover, and 89.09% line cover under the enforced 80% line gate.
