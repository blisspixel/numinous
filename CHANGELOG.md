...
- Status docs now match current evidence: 30 catalog rooms plus hidden content, 27 MCP tools, 833 passing tests, 90.01% region cover, and 89.57% line cover under the enforced 80% line gate.
