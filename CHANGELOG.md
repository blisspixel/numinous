...
- The final public-readiness baseline is 975 passing tests, 91.35% region coverage, and 90.94% line coverage under the documented exclusions, with the 80% line floor enforced locally and in CI.
