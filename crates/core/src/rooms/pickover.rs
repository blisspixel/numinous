...
impl Room for Pickover {
    ...
    fn motif(&self) -> Option<crate::motifs::Motif> {
        Some(crate::motifs::Motif {
            ...
            root: 277.18,
            tempo: 100,
            line: &[0, 4, 8, 12, 8, 4, 14, 8],
            encodes: "nested sin and cos with a z-memory",
        })
    }
    ...
    fn reveal(&self) -> &'static str {
        "Clifford Pickover popularized nested trigonometric maps that produce \
         swirling strange attractors in three dimensions. This room projects the \
         orbit and lets the hand retune the leading coefficients."
    }
}
...
mod tests {
    ...
    #[test]
    fn status_invites() {
        let s = Pickover::new().status(0.3).unwrap();
