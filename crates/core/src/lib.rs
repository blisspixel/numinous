...
pub use studio::{
    Expr, MAX_CREDIT_CHARS, MAX_MELODY_NOTES, MAX_META_TEXT_CHARS, MAX_PROGRAM_EXPRS,
    MAX_SHARE_INPUT_BYTES, MAX_STUDIO_EDITOR_CHARS, MAX_STUDIO_SOURCE_CHARS, NumFileError,
    PROGRAM_MARKS, STUDIO_EXPERIMENTS, STUDIO_RECIPES, StudioCreation, StudioExperiment,
    StudioKind, StudioPlot, StudioProgram, StudioScale, adjacent_construction_creation,
    adjacent_studio_experiment, eval, eval_field, eval_field_named, eval_named,
