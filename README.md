...
Studio, and game-input adapters, App game and input runtime adapters, plus CLI
and MCP render-input adapters and an MCP transport adapter, simulation-tool
adapter, Studio-tool adapter, and game-tool adapter. The App lifecycle, input,
