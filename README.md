...
The current local gate has 2,768 passing all-target test cases plus one ignored
screenshot diagnostic, 95.24% region coverage and 95.29% line coverage with an
