...
**Roughly 0.6 to First Light** (the honest scorecard lives in [`docs/ROADMAP.md`](docs/ROADMAP.md)). All three faces are real and green (Rust 1.96.0): fmt clean, clippy `-D warnings` clean, 918 tests, 90.79% region cover, and 90.32% line cover with an enforced 80% line gate. What exists today:
