...
| [`docs/ROOMS.md`](docs/ROOMS.md) | The catalog of phenomena (30 catalog rooms plus hidden content, 10 wings, 24 with verbs) and the Full Map of what remains |
...
**Roughly 0.6 to First Light** (the honest scorecard lives in [`docs/ROADMAP.md`](docs/ROADMAP.md)). All three faces are real and green (Rust 1.96.0): fmt clean, clippy `-D warnings` clean, 858 tests, 90.18% region cover, and 89.84% line cover with an enforced 80% line gate. What exists today:
