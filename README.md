...
The current local gate has 2,773 passing all-target test cases plus one ignored
screenshot diagnostic, 95.26% region coverage and 95.30% line coverage with an
