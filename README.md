...
| [`docs/ROOMS.md`](docs/ROOMS.md) | The catalog of phenomena (30 catalog rooms plus hidden content, 10 wings, 25 with verbs) and the Full Map of what remains |
...
**Roughly 0.6 to First Light** (the honest scorecard lives in [`docs/ROADMAP.md`](docs/ROADMAP.md)). All three faces are real and green (Rust 1.96.0): fmt clean, clippy `-D warnings` clean, 864 tests, 90.26% region cover, and 89.89% line cover with an enforced 80% line gate. What exists today:
