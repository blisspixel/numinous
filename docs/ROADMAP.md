...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 59):** nearly the full designed wave (first eight through Unlit Room, Lens, Fourteen Beacons, Loneliness Equation). Still open if any: Chord Game and any later frontier hooks.
