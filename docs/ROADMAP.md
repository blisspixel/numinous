...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 148):** inventing past designed cards (through continuous chaos; Lozi, baker, tent, Arnold circle, Chirikov, elliptical billiard).
