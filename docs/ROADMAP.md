...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   test module with their private access preserved, leaving the production
   entry point under 5,000 lines. Bounded runtime validation of the declared
   ...
   catalog remains the immutable protocol contract. The remaining
