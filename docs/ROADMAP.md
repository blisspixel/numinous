...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 94):** full designed Next Wave and Awe Engine waves; Function Painter; classical fractals; universal wonder Tier S/A; Soap Film; Landauer; Prime Gap Weather. Remaining designed depth: Sphere Eversion, a few frontier toys.
