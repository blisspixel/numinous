...
| 0.6 Portable | Partial | release packaging, engagement smoke, provenance/SBOM, install/play/uninstall roundtrip with all three player-owned files preserved, not just the journey, run nightly against a freshly packaged archive as well as on the tagged artifact |
