...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 130):** inventing past designed cards (through Menger; bifurcation, Stern-Brocot, Josephus, Calkin-Wilf, Gibbs, Sierpinski arrowhead).
