...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 100):** designed Next Wave, Awe Engine, Function Painter, universal wonder, frontier toys, Mirror of Forms. Written design cards largely cleared; inventing continues.
