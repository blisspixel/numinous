...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   entry point only gathers raw environment values and prints the report. The
