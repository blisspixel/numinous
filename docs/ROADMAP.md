...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 208):** inventing past designed cards (through Hyperbolic Tiling, Mackey-Glass, Fermat Spiral, Euclid, Oregonator, Hofstadter Q).
