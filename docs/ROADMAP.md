...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   remain in the request entry point. CLI Studio source selection,
   ...
   focused face-local adapter too. Core retains Studio evaluation, rendering,
   capsule validity, and lineage semantics. Shared bounded CLI game records,
