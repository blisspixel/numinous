...
- **Built:** a plotted or sung Studio experiment names `next` as
  ...
  The piano roll is built: the sung MIDI voice as pitch over time.
  The rest of the in-app capability quest remains later rungs.
