...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 232):** inventing past designed cards (through Involute, Evolute, Pedal, Roulette, Damped Sine, Beats).
