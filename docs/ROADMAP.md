...
| 0.6 Portable | Partial | release packaging, engagement smoke, provenance/SBOM, install/play/uninstall roundtrip with player state preserved, run nightly against a freshly packaged archive as well as on the tagged artifact |
