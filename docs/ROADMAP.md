...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Twenty-nine new room designs across four aspects (physics, deep mathematics, fun-first, cosmic), recorded in `ROOMS.md` under "The Next Wave". **Built (catalog 55):** first eight plus deep remainder (percolation, Ising, Kepler, phantom jam, brachistochrone, look-and-say, busy beaver, 720, p-adics, boids, elliptic billiards, Physarum, Lorentz cone, Hubble stretch, Laplace resonance, Hamming heal). Remainder: Unlit Room, Lens, Fourteen Beacons, Loneliness Equation, Chord Game, and kin.
