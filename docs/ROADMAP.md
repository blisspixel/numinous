...
| Real creative surface | Studio expressions, `.num` serialization, links, plotting, animation, singing, and exact paused App reopen exist | Local gallery, fork/remix, safe share preview for incoming links, and clean-install round trip |
