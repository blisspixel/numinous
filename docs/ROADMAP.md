...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 106):** designed waves largely cleared; inventing past 100 (Penrose, continued fractions, logistic cobweb, Sierpinski carpet, Pythagoras tree, Ulam spiral).
