...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 244):** inventing past designed cards (through Doppler, Interference, Diffraction, Snell, Polarization, Brewster).
