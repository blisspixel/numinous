...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 142):** inventing past designed cards (through attractor maps; Pickover, Aizawa, Thomas, Halvorsen, Rabinovich-Fabrikant, three-scroll).
