...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 160):** inventing past designed cards (through chaos geometry; Gauss, Manneville, coupled tents, Koch snowflake, Cesaro, Minkowski sausage).
