...
- **Built:** a plotted or sung Studio experiment names `next` as
  ...
  `three-readings`. Height and phase sing that reading along the real
  axis; the zero reading stays silent.
