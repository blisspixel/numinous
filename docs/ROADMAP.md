...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 190):** inventing past designed cards (through Percolation, Ising, Lotka-Volterra, Poincare Disc, Cycloid, Brusselator).
