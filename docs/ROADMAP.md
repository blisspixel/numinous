...
- **Done (catalog art-first and plate quality, cycles 161 to 163, PRs #63 to
  ...
  **0 dead-domain** rooms (base raster equals interacted), and **0 dead dials**
  ...
  a human gate.
- **Done (live motion pack, cycles 164 to 166):** classic curve and wave rooms
  ...
  Strophoid, Piriform, Hippopede), unfurls spirals (Log Spiral, Cochleoid,
  Fermat Spiral), oscillates standing waves, scrolls Fourier partials, and
  advances Poisson staircases. Docs (RESEARCH, PLAYFUL, NORTH_STAR, QUALITY,
  ROOMS, README) codify the six-question plate filter and contact/MCP posture.
  Tests assert distinct ambient frames. Fun and motion before more densify
  grind.
