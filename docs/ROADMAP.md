...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   reducing that coordinator again to 4,491 lines. Existing helper modules
   retain rendering, discovery, validation, serialization, device
   normalization, hit testing, gesture mechanics, and domain rules. The 159
