...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   in a focused protocol adapter. Seeded prediction and touch or parameter
   challenge posing, grading, structured result projection, and progress
   accounting now live in a focused challenge adapter, leaving the production
   entry point under 3,700 lines. Bounded runtime validation of the declared
