...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 118):** inventing past designed cards (through dragon/Henon/Rule 30/Mandelbulb; Thue-Morse, Rossler, Cantor, Weierstrass, Peano, Van der Pol).
