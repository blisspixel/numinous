...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 202):** inventing past designed cards (through Cardioid, Deltoid, Coupled Logistic, Menger Sponge, Theodorus, Rule 110).
