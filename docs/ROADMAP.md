...
4. Expand 0.6-am install roundtrips and 0.7-am App/MCP creator parity.
   ...
   for a face that draws pixels rather than characters. One blocker sits behind the rest of 0.7 and needs a product
