...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 220):** inventing past designed cards (through Gerono, Cissoid, Strophoid, Conchoid, Limacon, Folium).
