...
**Current release state: 0.4.0-alpha.26, Understanding Alpha active with its exit
...
- **Done (Cycle 21 first-contact and flagship goldens, August 2, 2026):**
  `agent-first-contact.py` cold-starts 41 tools, multi-wing play, munch, journal
...
The package is **0.4.0-alpha.26**. The 0.1 Public Foundation exit criterion is
...
Package label is **0.4.0-alpha.26** because Understanding Alpha is the active
