...
| Real creative surface | Studio expressions, `.num` serialization, links, plotting, animation, singing, exact paused App reopen, the one-key share trio, and the local Gallery wall exist | Fork/remix with lineage, safe share preview for incoming links, and clean-install round trip |
