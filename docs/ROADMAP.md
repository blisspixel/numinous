...
- **Done (live motion pack, cycle 164):** classic curve and wave rooms stop
  ...
  Cycloid, Astroid), walks pens, unfurls the log spiral, oscillates standing
  waves, scrolls Fourier partials, and advances Poisson staircases. Tests
  assert t=0 and t=0.25 (or similar) change the raster. Fun and motion before
  more densify grind.
