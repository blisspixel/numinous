...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 214):** inventing past designed cards (through Dual Cobweb, Beverton-Holt, Witch of Agnesi, Tractrix, Catenary, Clothoid).
