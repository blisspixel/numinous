...
- **Done (Engine A2 cross-face evidence):** the room-bed source rate, event cap,
  ...
  across all 352 rooms, and enforce the 96-event and 64 KiB protocol budgets.
...
- **Done (catalog growth through 352):** invent-and-ship past the early Next
  Wave and classical cards into dynamics, number theory, probability,
  topology, analysis, theory formation, and closing gems. MCP `list_rooms` count is 352; every
...
(3) six first pokes, now generalized into all 352 catalog rooms with verbs;
...
open until the Times Tables stranger hallway test passes. Current breadth is 352
...
|---|---|---|
| Complete coherent collection | 352 catalog rooms are built and listed | A coherent cold start, pacing, keep-or-cut review, and several planned signature rooms |
