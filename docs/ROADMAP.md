...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   grading, and mathematical truth, leaving the production entry point under
   1,300 lines. Bounded runtime validation of the declared
