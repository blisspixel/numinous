...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 178):** inventing past designed cards (through gaskets and escape sets; Nova, Magnet Fractal, Lambda Map, Feigenbaum Ladder, Menger Carpet, Vicsek).
