...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 112):** inventing past designed cards (Penrose through Ulam; dragon curve, Fibonacci word, cubic Newton, Henon, Rule 30, Mandelbulb slice).
