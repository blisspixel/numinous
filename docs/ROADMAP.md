...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 172):** inventing past designed cards (through gaskets; Burning Ship, Tricorn, Multibrot, Phoenix, Lyapunov, Collatz tree).
