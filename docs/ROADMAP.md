...
1. **Time and company over MCP.** Exact two-observation evidence with a typed
   ...
   and MCP creation and lineage parity are built. Next come a Show for minds
   and journal surfacing at the door of a remembered room. Ratio annotations on
...
3. Continue the Mind's Seat now that deliberate remembered-room retrieval and
   MCP creation and lineage parity exist: surface journal evidence at the room
   door, then build the Strange Loop threshold.
