...
- **Built:** a plotted or sung Studio experiment names `next` as
  ...
  The step-grid reading of those rows is built: a numbered header and
  App cells. Tracker editing, piano roll, and the rest of the in-app
