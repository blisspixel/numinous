...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 238):** inventing past designed cards (through Gibbs Square, Sawtooth, Triangle Wave, AM, FM, Standing Wave).
