...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 184):** inventing past designed cards (through Chua, Cat Map, Blancmange, Rose, Kuramoto, H-Tree).
