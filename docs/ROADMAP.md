...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 82):** full designed Next Wave and Awe Engine waves; Function Painter; Newton/Koch/Hilbert; Gray-Scott; Sieve. Content wave continues inventing classical and emergent rooms.
