...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 76):** full designed Next Wave including Chord Game; Awe Engine Tier S complete; Tier A/B complete (Apollonian, Inversion, DLA Frost, Kaprekar, Steiner, Hopf, Wireworld, Buddhabrot, Harmonics). Remaining designed depth: domain coloring / Function Painter Studio flagship.
