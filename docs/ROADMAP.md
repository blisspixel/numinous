...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   retains their state machines and truth, leaving the production entry point
   under 2,200 lines. Bounded runtime validation of the declared
