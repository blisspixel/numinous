...
7. **The structural debts, scheduled rather than deplored.** Cross-face
   ...
   save failures now live in a focused progress adapter, leaving the production
   entry point under 3,100 lines. Bounded runtime validation of the declared
