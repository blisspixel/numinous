...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 77):** full designed Next Wave; Awe Engine Tier S and A/B complete; Function Painter domain-coloring flagship shipped as a curated complex-map rack (Studio free-expression wiring remains a later Studio path).
