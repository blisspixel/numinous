...
- **Next (in order):** Engine B (the ElevenLabs radio); the music visualizer (system loopback + FFT); GPU paths for more rooms; gamepad support; hexaflexagons and the Hat tile; per-era chiptune voicing.
