...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 226):** inventing past designed cards (through Semicubical, Kappa, Circular Caustic, Trochoid, Hypotrochoid, Epitrochoid).
