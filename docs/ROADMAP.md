...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 67):** full designed Next Wave including Chord Game, plus Awe Engine Tier S (Recaman, Truchet, Pursuit, Pascal mod n, Three-Gap, Morley, Menagerie/Clifford). Remaining designed depth: Awe Engine Tier A/B and Function Painter flagship.
