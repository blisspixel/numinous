...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 154):** inventing past designed cards (through classical maps; horseshoe, logistic orbit, Sinai, Henon-Heiles, quadratic map, doubling map).
