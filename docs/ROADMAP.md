...
- **In progress (the founder's directive, July 2026): The Next Wave of rooms.** Designs in `ROOMS.md`. **Built (catalog 91):** full designed Next Wave and Awe Engine waves; Function Painter; classical fractals; Gray-Scott; Sieve; universal wonder Tier S/A (dimension, concentration, uncertainty, gradient, attention, Braess, nontransitive dice, Parrondo, Hilbert hotel).
