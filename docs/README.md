...
selections. Catalog plate quality (cycles 161 to 166) holds art-first
...
(not a static graph), including the cycle-166 pen and unfurl pack; soft-thin
densify continues where honest. The six-question plate filter, contact-language,
and MCP teammate posture live in `RESEARCH.md`. Public CI passes on Windows, macOS, and Ubuntu, but capability
